...
public class DailyMealPlanCustomList extends ArrayAdapter<DailyMealPlan> {
...
/*method comment*//*
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // and extract its information from the dailyMealPlans list
        DailyMealPlan meal = dailyMealPlans.get(position);
        // and get this meal's description using the document ID
        ...

        // best before date and unit count to the corresponding Textview object for displaying on the activity
        TextView mealTitle = view.findViewById(R.id.*/
/* insertIdHere *//*
);
        mealTitle.setText(*/
/* insertDescriptionFromDB *//*
);
