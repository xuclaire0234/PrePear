...
public class Recipe implements Serializable {
    ...
    public Recipe(Uri imageURI, String title, Integer preparationTime,Integer numberOfServings, String recipeCategory, String comments, ArrayList<IngredientInRecipe> listOfIngredients) {
